...
> ⚠️ **状态:Snapshot,不再维护**。本仓库是 Code Light 的开源参考 snapshot(已剥除订阅 / 内购 / 配对付费墙)。生产版本在 App Store 同名 app。本仓库不接受 Issue / PR。
...
这是一个**出于个人兴趣**的项目,参考源代码在 **CC BY-NC 4.0** 协议下公开,**仅限个人学习、研究、教育使用**,禁止商业用途。

> 📌 **本仓库是开源参考的只读 snapshot,不再维护 — Issue 和 PR 不会被审查**。完整功能版(含订阅、内购、付费配对)请从 [App Store](https://apps.apple.com/us/app/code-light/id6761744871) 下载。
