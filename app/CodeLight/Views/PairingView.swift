...
struct PairingView: View {
    ...
    // Pre-pair Settings access (gear icon top-right). Critical for App Store
    // review: reviewers must be able to find the IAP before pairing — without
    // this entry point they land on PairingView with no path to the paywall.
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showSettings, onDismiss: {
            // Mirror LinkedMacsListView: if Settings set pendingSubscriptionPaywall
            // before dismissing, present the paywall now from this presentation level.
