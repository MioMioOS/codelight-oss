...
// OSS edition: subscription gating + concurrency-guard intentionally removed.
...
export function startSocket(server: HttpServer) {
    ...
    io.on('connection', async (socket) => {
        ...
        // OSS edition: every authenticated socket is admitted unconditionally.
        ...
        socket.on('disconnect', () => {
            ...
            // OSS edition: concurrencyGuard.removeConnection call removed
            // (concurrencyGuard module deleted along with subscription system).
        });
    });
